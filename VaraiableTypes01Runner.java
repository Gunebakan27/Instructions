...
public class VaraiableTypes01Runner {
	...
	public static void main(String[] args) {
		...
		System.out.println(obj1.id);//null Note: "id" has yellow underline because you created an object 
												//to access static variable. no need to do it, because class name is enough
		obj1.id="New Id";
