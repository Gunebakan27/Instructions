...
//	If the access modifier is default, the data will be visible inside the entire package.
...
//	and from every child classes. Even they are in different packages.
	protected String grade="11";
	
	
//	If you use public access modifier, the class member(variables and methods) will be visible
